...
const ProfileSideBar = ({ active }) => {
  ...
  return (
    <div className=" w-[20%] md:w-[20%] lg:w-[20%] fixed pb-12 mt-1 lg:mt-3 h-[90vh] bg-gradient-to-r from-slate-200 to-slate-400 ...  shadow-md overflow-y-scroll scrollbar-none  rounded-md ">
      ...
      <div className="hidden lg:flex items-center p-3">
        <Link to="/profile/payment-method" className="w-full flex items-center">
          <FaRegCreditCard size={26} color="blue" />
          <h5
            className={`block pl-2 text-[16px] font-semibold ${
