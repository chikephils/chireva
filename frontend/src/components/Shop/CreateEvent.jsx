...
const CreateEvent = () => {
  ...
  return (
    <div className=" h-full w-full items-center justify-center px-2 ">
      <>
        {showLoader && (
          <div className="absolute top-0 left-0 w-full h-full bg-gray-200 opacity-50 z-[1000] flex items-center justify-center">
            <CreateLoader />
          </div>
        )}
      </>
