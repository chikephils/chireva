...
const ProfileSideBar = ({ active }) => {
  ...
  return (
    <div className=" w-[20%] md:w-[20%] lg:w-[20%] fixed pb-1 mt-1 lg:mt-3 h-[85vh] bg-gradient-to-r from-slate-200 to-slate-400 ...  shadow-md overflow-y-scroll scrollbar-none  rounded-md ">
