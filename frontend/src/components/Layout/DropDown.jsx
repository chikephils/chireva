...
const DropDown = ({ categoriesData, setDropDown }) => {
  ...
  return (
    <div className=" mt-0 md:mt-0 pb-6 w-[270px] md:w-[270px] bg-gradient-to-r from-gray-200 to-slate-200 ... absolute z-30 rounded-b-md shadow-2xl border border-black overflow-y-auto scrollbar-thin max-h-[80vh]">
      {categoriesData &&
