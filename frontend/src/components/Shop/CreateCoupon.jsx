...
const CreateCoupon = ({ seller, setOpen, refreshCoupons, shopProducts }) => {
        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="mt-1 cursor-pointer appearance-none block w-full px-3 py-1 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-lime-400 focus:border-lime-500 text-[14px] md:text-sm"
            />
          </div>
          <br />
          <div>
